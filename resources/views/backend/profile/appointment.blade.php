			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 style="margin-top: 10px;">		
						<a href="{{route('appointment.create', ['user_id'=>Auth::user()->id])}}" class="btn btn-sm btn-primary pull-right">Add Appointment Schedule</a>
						<!-- <a href="{{route('appointment.edit',$user->id)}}" class="btn btn-sm btn-primary pull-right">Edit Appointment Schedule</a> -->
					</h3> 
				</div>
