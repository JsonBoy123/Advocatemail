...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{url('g_profile')}}"Title="Click Here to Display Your Profile">My Profile</a>
                    <a class="collapse-item" href="{{url('g_profile_edit')}}"Title="Click Here to Edit or To Complete The Missing Data In Your Profile">Edit Profile</a>
                </div>
            </div>
        </li>

        <li class="nav-item active">
            <a class="nav-link" href="{{url('g_appointment')}}">
                <i class="fas fa-fw fa-cog"></i>
        ...
        <li class="nav-item active">
            <a class="nav-link" href="{{url('/g_message')}}">
                <i class="fas fa-fw fa-cog"></i>
        ...
        <li class="nav-item active">
            <a class="nav-link" href="{{url('g_password')}}">
                <i class="fas fa-fw fa-cog"></i>
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <a class="dropdown-item" href="{{url('g_profile')}}">
